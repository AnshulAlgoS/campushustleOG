  ...
  return (
    <div className="legal-gradient">
      <div className="legal-page-container">
        ...
        <p className="legal-paragraph">
          At Campus Hustle, we respect your privacy and are committed to protecting it.
        ...
        <ul className="legal-list">
          ...
          <li>Third-party services (e.g., analytics tools) may process data as per their own policies.</li>
        </ul>
