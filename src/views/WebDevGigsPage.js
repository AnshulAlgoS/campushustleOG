        ...
        <div className="top-strip">
          ...
          <nav className="navbar-desktop">
            <ul className="strip-nav">
              ...
              <li><Link to="/" state={{ scrollTo: 'community' }} className="desktop-link-btn">Community</Link></li>
              <li><Link to="/about">About Us</Link></li>
              <li>
                {user ? (
                  <UserMenu user={user} onLogout={() => auth.signOut()} onProfileClick={() => navigate('/profile')} />
                ) : (
          ...
          <div className="navbar-mobile">
            ...
            {menuOpen && (
              <ul className={`mobile-nav ${menuOpen ? 'open' : ''}`}>
                ...
                <li>
                  {user ? (
                    <UserMenu user={user} onLogout={() => { setMenuOpen(false); auth.signOut(); }} onProfileClick={() => { setMenuOpen(false); navigate('/profile'); }} />
                  ) : (
                    <button className="signup" onClick={() => { setMenuOpen(false); navigate('/auth'); }}>Get Started</button>
                  )}
                </li>
              </ul>
            )}
                ...
                <div className="card-body">
                  ...
                  <div className="card-footer">
                    ...
                    <div className="btn-group">
                      <button className="details-btn" onClick={() => navigate(`/gig/${gig.id}`)}>Details</button>
                      {alreadyApplied ? (
      ...
      {selectedGig && (
        <div className="modal-overlay" onClick={() => setSelectedGig(null)}>
          <div className="modal-box" onClick={(e) => e.stopPropagation()}>
            ...
            <textarea placeholder="Why are you fit for this gig?" value={reason} onChange={(e) => setReason(e.target.value)}></textarea>
