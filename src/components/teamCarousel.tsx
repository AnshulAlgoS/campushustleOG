...
export const members: TeamMember[] = [
    {
        ...
        image: anshulImg,
        bio: 'Building student-first platforms with love.',
        linkedin: 'https://www.linkedin.com/in/anshulalgos'
    },
    {
        id: '2',
        name: 'Mahira Khan',
        ...
        image: mahiraImg,
        bio: 'Turning visions into vibrant UI.',
        linkedin: 'https://linkedin.com/in/mahira'
    },
    {
        id: '3',
        name: 'Gourika',
...
export const TeamCarousel: React.FC<TeamCarouselProps> = ({
    ...
    return (
        ...
        >
            ...
            {/* Carousel Container */}
            <div
                className="w-full max-w-6xl relative mt-20 px-4 sm:px-6"
                style={{
            ...
            >
                ...
                {showArrows && (
                    <>
                        <motion.button
                            onClick={() => paginate(-1)}
                            className="absolute left-5 top-1/2 transform -translate-y-1/2 bg-black/60 hover:bg-black/80 text-white w-10 h-10 rounded-full flex items-center justify-center z-20 transition-all duration-300 hover:scale-110 shadow-[0_0_10px_#b66baf]"
                            whileTap={{ scale: 0.9 }}
                        >
                ...
                {/* Cards Track */}
                <div
                    className="w-full h-full flex justify-center items-center relative -mt-52"
                        ...
                        {members.map((member, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    style={{
                                        width: window.innerWidth < 468 ? cardWidth * 0.85 : cardWidth,
                                        height: window.innerWidth < 468 ? cardHeight * 0.85 : cardHeight,
                                ...
                                >
                                    <img
                                        src={member.image}
                                        alt={member.name}
                                        className="w-full h-full object-cover sm:object-cover object-top"
                                    />
